...
translations = {
    "English": {
        ...
        "payment_success": "🎉 Payment successful! Your storage has been increased to {} GB.",
        "plan_info": "🚀 <b>Plan: {}</b>\n💰 <b>Price: {} UAH</b>\n\nClick the button below to pay on the official website. Your storage will be updated automatically after payment.",
        "pay_button": "💳 Pay",
        "subscription_reminder": "🔔 Your storage subscription expires soon. Please renew to keep your files.",
        "renew_button": "💳 Renew",
        "cancel_subscription": "❌ Cancel Subscription",
        "subscription_cancelled": "🗑️ Subscription cancelled. Your storage will be reset to 2 GB and files cleared.",
        "categories": {
            "Photos": "🖼️ Photos",
            "Videos": "🎬 Videos",
            "Programing": "💻 Coding",
    ...
    "Ukrainian": {
        ...
        "payment_success": "🎉 Оплата успішна! Ваше сховище збільшено до {} ГБ.",
        "plan_info": "🚀 <b>Тариф: {}</b>\n💰 <b>Ціна: {} UAH</b>\n\nНатисніть кнопку нижче для оплати на офіційному сайті. Сховище оновиться автоматично після оплати.",
        "pay_button": "💳 Оплатити",
        "subscription_reminder": "🔔 Термін дії вашої підписки на сховище закінчується. Будь ласка, оплатіть тариф, щоб зберегти ваші файли.",
        "renew_button": "💳 Поновити",
        "cancel_subscription": "❌ Відмовитись від підписки",
        "subscription_cancelled": "🗑️ Підписку скасовано. Ваше сховище обмежено до 2 ГБ, а файли видалено.",
        "categories": {
            "Photos": "🖼️ Фото",
            "Videos": "🎬 Відео",
